...
export default function Home() {
  return <main>
    ...
    <section className="offer"><div className="offer-lines" aria-hidden="true"/><div className="offer-copy"><p className="eyebrow"><span/> Sua avaliação</p><h2>Tudo começa entendendo o seu caso.</h2><p>Cada pessoa possui uma necessidade diferente. A avaliação permite entender a área de cobertura, o cabelo existente e o resultado desejado antes de indicar a solução.</p></div><aside><span>Benefício</span><p>Fechando sua prótese após a avaliação, sua primeira manutenção é por nossa conta.</p><small>Uma forma de acompanhar de perto o começo dessa nova fase.</small></aside></section>
